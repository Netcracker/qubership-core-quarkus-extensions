...
public interface DbaaSOpensearchCreationConfig {
    ...
    /**
     * physical-database-id with opensearch creation parameters for all tenant database.
     */
    @WithName("tenant.physical-database-id")
    Optional<String> singleTenantPhysicalDatabaseId();

    /**
     * prefix-config with opensearch creation parameters for all tenant database.
     */
